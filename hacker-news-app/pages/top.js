/**
 * Component: Top
 * Description: A Next.js page that displays a table of Top stories
 */
...
export const getServerSideProps = async () => {
  ...
  const storiesRes = await axios.get(
    'https://hacker-news.firebaseio.com/v0/topstories.json?print=pretty&orderBy="$key"&limitToFirst=50'
  );
