/**
 * Component: Show
 * Description: A Next.js page that displays a table of Show stories
 */
...
const Show = ({ stories }) => {
  return (
    <>
      <h1 className={styles.heading}>Show Stories</h1>
      <Dropdown />
...
export const getServerSideProps = async () => {
  ...
  const storiesRes = await axios.get(
    'https://hacker-news.firebaseio.com/v0/showstories.json?print=pretty&orderBy="$key"&limitToFirst=50'
  );
