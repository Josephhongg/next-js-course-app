/**
 * Component: Job
 * Description: A Next.js page that displays a table of Job stories
 */
...
const Job = ({ stories }) => {
  return (
    <>
      <h1 className={styles.heading}>Job Stories</h1>
      <Dropdown />
...
export const getServerSideProps = async () => {
  ...
  const storiesRes = await axios.get(
    'https://hacker-news.firebaseio.com/v0/jobstories.json?print=pretty&orderBy="$key"&limitToFirst=50'
  );
