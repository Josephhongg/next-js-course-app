/**
 * Component: Ask
 * Description: A Next.js page that displays a table of Ask stories
 */
...
const Ask = ({ stories }) => {
  return (
    <>
      <h1 className={styles.heading}>Ask Stories</h1>
      <Dropdown />
...
export const getServerSideProps = async () => {
  ...
  const storiesRes = await axios.get(
    'https://hacker-news.firebaseio.com/v0/askstories.json?print=pretty&orderBy="$key"&limitToFirst=50'
  );
