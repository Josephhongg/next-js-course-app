/**
 * Component: New
 * Description: A Next.js page that displays a table of New stories
 */
...
const New = ({ stories }) => {
  return (
    <>
      <h1 className={styles.heading}>New Stories</h1>
      <Dropdown />
...
export const getServerSideProps = async () => {
  ...
  const storiesRes = await axios.get(
    'https://hacker-news.firebaseio.com/v0/newstories.json?print=pretty&orderBy="$key"&limitToFirst=50'
  );
